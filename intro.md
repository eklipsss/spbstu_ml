...
**Этапы:**
1) Научиться генерировать отдельные части дендритов независимо от меток
2) Добавить условие **Организм** и проверить mouse/human
3) Исследовать технический сдвиг MICrONS / LabID на здоровых мышах (сдвиг, обусловленный не отличиями в морфологии дендритов, а отличиями в донорах, протоколах фиксации, электронной микроскопии, сегментации и постобработки)
4) После выравнивания технического сдвига определить морфологический сдвиг LabID healthy / LabID disease
5) Проверить нейродегенеративное преобразование внутри мышей на отложенной выборке нейронов
6) Только после успешной проверки нейродегенеративного преобразования на мышах добавить проверку на человеческих дендритах.
